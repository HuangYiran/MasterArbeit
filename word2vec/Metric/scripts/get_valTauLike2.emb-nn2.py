...
def main():
    ...
    chrF1= "python code/NNMetric/test4.py -hyp " + o_s1 + " -join " + opt.mode + " -output /tmp/tmp1" + " -ref " + o_ref
    chrF2= "python code/NNMetric/test4.py -hyp " + o_s2 + " -join " + opt.mode + " -output  /tmp/tmp2" + " -ref " + o_ref
    chrF3= "Python code/NNMetric/test4.py -hyp " + o_ref + " -join " + opt.mode2 + " -output /tmp/tmp3"
...
#    chrF2= "python code/NNMetric/test.py -hyp " + opt.s2 + " -ref " + opt.ref + "  -w2v data/word2vec/GoogleNews-vectors-negative300-SLIM.bin.gz -join max > ./tmp/tmp2"
    ...
    chrF1= "python code/NNMetric/test4.py -hyp " + o_test_s1 + " -join " + opt.mode + " -output /tmp/test1" + " -ref " + o_test_ref
    chrF2= "python code/NNMetric/test4.py -hyp " + o_test_s2 + " -join " + opt.mode + " -output /tmp/test2" + " -ref " + o_test_ref
    chrF3= "Python code/NNMetric/test4.py -hyp " + o_test_ref + " -join " + opt.mode2 + " -output /tmp/test3"
#    chrF1= "python code/NNMetric/test.py -hyp " + opt.s1 + " -ref " + opt.ref + "  -w2v data/word2vec/GoogleNews-vectors-negative300-SLIM.bin.gz -join max > ./tmp/tmp1"
#    chrF2= "python code/NNMetric/test.py -hyp " + opt.s2 + " -ref " + opt.ref + "  -w2v data/word2vec/GoogleNews-vectors-negative300-SLIM.bin.gz -join max > ./tmp/tmp2"
    print (chrF1)
    print (chrF2)
