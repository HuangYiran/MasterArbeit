...
parser.add_argument('-csv', default = "./data/wmt15-deen.csv", help = "the csv file to extract the scores")
parser.add_argument('-sys', default = "./data/de-en_2015/sys/", help = "the dir to save the system output file")
parser.add_argument('-ref', default = "./data/newstest2015-deen-ref.en", help = "the reference file")
parser.add_argument('-src', default = "./data/newstest2015-deen-src.de", help = "the source file")
