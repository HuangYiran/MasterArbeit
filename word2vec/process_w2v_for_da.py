"""
run the get_hidden function to get the vector for each sentence
only for the da data
"""
...
parser.add_argument('-model', default = './model/english/GoogleNews-vectors-negative300.bin', help = "the word2vec model, should coordinate with the input file")
parser.add_argument('--bin', action = 'store_true', help = "set when load the binary model")
